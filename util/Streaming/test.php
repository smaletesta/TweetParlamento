...
class TrackTwitterAccounts extends OauthPhirehose {
    ...
    public function __construct($username, $password, $queueDir = './streams', $rotateInterval = 3600) {
        parent::__construct($username, $password, Phirehose::METHOD_FILTER, Phirehose::FORMAT_JSON);
        $this->db = new db();  
        //$userIds = $this->getAccounts();
        $userIds = array(18935802,133790890,19067940,289400495,87185750,52424550);
    ...
    */
    ...
    private function getAccounts() {
        $query = 'SELECT user_id FROM Account_Twitter';
...
// Start streaming
$sc = new TrackTwitterAccounts(OAUTH_TOKEN, OAUTH_SECRET);
